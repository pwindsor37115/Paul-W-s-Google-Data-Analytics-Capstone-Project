...
ggplot(summarized_data_hour, aes(x = hour_am_pm, y = total_rides, fill = member_casual)) +
  ...
  theme(plot.title = element_text(hjust = 0.5), 
        ...
        axis.text.x = element_text(angle = 45, hjust = 1, size = 8),  # Rotate x-axis labels and set font size
        axis.text.y = element_text(size = 8),  # Set font size for y-axis labels
        legend.position = "top",  # Move legend to the top
        legend.box.margin = margin(0, 0, -20, 0),  # Reduce legend size by 50%
        legend.key.size = unit(0.5, "lines"),  # Further reduce legend key size
        legend.title = element_blank(),
        plot.margin = margin(t = 30))  # Adjust top margin of the plot
```
